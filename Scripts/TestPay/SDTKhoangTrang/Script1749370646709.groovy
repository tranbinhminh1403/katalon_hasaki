...
WebUI.click(findTestObject('Object Repository/Page_Hasaki.vn  M Phm  Clinic/button_T chi'))
...
WebUI.click(findTestObject('Object Repository/Page_Thanh ton  Hasaki.vn/p_S in thoi khng hp l'))
