...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Thanh ton  Hasaki.vn/p_Vui lng chn Tnh TP, Qun Huyn'), 'Vui lòng chọn Tỉnh/ TP, Quận/ Huyện')
...
WebUI.rightClick(findTestObject('Object Repository/Page_Thanh ton  Hasaki.vn/p_Vui lng chn Phng X'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Thanh ton  Hasaki.vn/p_a ch phi t 5 k t'), 'Địa chỉ phải từ 5 ký tự')
