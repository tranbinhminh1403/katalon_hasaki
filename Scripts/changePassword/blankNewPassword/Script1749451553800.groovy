...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Thay i mt khu  Hasaki.vn/input_Mt khu hin ti_password'), 'aeHFOx8jV/A=')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Thay i mt khu  Hasaki.vn/input_Mt khu mi_passwordNew'), 'CGdKCyZFPkc=')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Thay i mt khu  Hasaki.vn/input_Nhp li_passwordConfirm'), 'CGdKCyZFPkc=')

WebUI.click(findTestObject('Object Repository/Page_Thay i mt khu  Hasaki.vn/button_Cp nht'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Thng Tin Ti khon  Hasaki.vn/div_Thng tin ti khon'), '1')
