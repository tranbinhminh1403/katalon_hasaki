...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Thay i mt khu  Hasaki.vn/input_Mt khu hin ti_password'), 'SFTQUhjBfIY=')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Thay i mt khu  Hasaki.vn/input_Mt khu mi_passwordNew'), 'aeHFOx8jV/A=')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Thay i mt khu  Hasaki.vn/input_Nhp li_passwordConfirm'), 'aeHFOx8jV/A=')

WebUI.click(findTestObject('Object Repository/Page_Thay i mt khu  Hasaki.vn/button_Cp nht'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Thay i mt khu  Hasaki.vn/div_Mt khu hin ti khng ng'), 'Mật khẩu hiện tại không đúng')
