...
WebUI.click(findTestObject('Object Repository/Page_Gi hng (3 sn phm)  Hasaki.vn/svg_Xa_text-foreground'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Gi hng (2 sn phm)  Hasaki.vn/input_Xa_outline-none border-1px px-1.5 tex_31f081'), 
    '')
