...
WebUI.rightClick(findTestObject('Object Repository/Page_Hasaki.vn  M Phm  Clinic/img_Retinol_loaded'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Ti khon ca ti  Hasaki.vn/div_Thng tin ti khon'), 5)
