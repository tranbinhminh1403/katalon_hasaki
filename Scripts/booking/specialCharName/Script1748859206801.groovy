...
WebUI.setText(findTestObject('Object Repository/Page_Booking SPA  Hasaki.vn/input__fullName'), 'Hạ@@@123')

WebUI.click(findTestObject('Object Repository/Page_Booking SPA  Hasaki.vn/button_t hn'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Booking SPA  Hasaki.vn/div_Tn khng c cha k t c bit'), 'Tên không được chứa kí tự đặc biệt !')
